                                    ...
                                    <>
                                      ...
                                      {bet.betType === 'parlay' && bet.legs && (
                                        <div className="mb-3 space-y-2">
                                          {formatParlayLegs(bet).slice(0, 3).map((leg, legIndex) => (
                                      ...
                                      <div className="grid grid-cols-3 gap-3 pt-3 border-t border-border/20">
                                        ...
                                        <div className="text-center">
                                          ...
                                          <div className="text-sm font-bold text-accent">${(bet.potentialPayout || 0).toFixed(2)}</div>
                                        </div>
                                      </div>
                                    </>
                                  ) : (
                            ...
                            >
                              ...
                              <div className="space-y-2 mb-3">
                                {(Array.isArray(slip.bets) ? slip.bets : []).map((bet) => (
                                  <div key={bet.id} className="flex items-center justify-between py-1.5 border-b border-border/10 last:border-b-0">
                              ...
                              <div className="flex items-center justify-between pt-3 border-t border-border/20">
                                <div className="flex items-center gap-4">
                                  ...
                                  <div className="text-xs">
                                    <span className="text-muted-foreground font-semibold">Won: </span>
