    ...
    <div className="h-full flex flex-col overflow-hidden bg-background">
      ...
      <div className="flex-1 overflow-hidden">
        <Tabs value={selectedTab} onValueChange={setSelectedTab} className="h-full flex flex-col">
          ...
          <div className="flex-1 overflow-auto seamless-scroll" style={{ padding: 'var(--fluid-panel-padding)', fontSize: 'var(--fluid-base)' }}>
            <TabsContent value="main" className="mt-0 space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                >
                  <Card style={{ fontSize: 'var(--fluid-base)', borderRadius: 'var(--fluid-radius)' }}>
                    <CardHeader className="pb-3">
                      <CardTitle style={{ fontSize: 'var(--fluid-lg)' }}>Point Spread</CardTitle>
                    </CardHeader>
                ...
                >
                  <Card style={{ fontSize: 'var(--fluid-base)', borderRadius: 'var(--fluid-radius)' }}>
                    <CardHeader className="pb-3">
                      <CardTitle style={{ fontSize: 'var(--fluid-lg)' }}>Moneyline</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-3">
                      <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                        <Button
                ...
                >
                  <Card style={{ fontSize: 'var(--fluid-base)', borderRadius: 'var(--fluid-radius)' }}>
                    <CardHeader className="pb-3">
                      <CardTitle style={{ fontSize: 'var(--fluid-lg)' }}>Total Points</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-3">
                      <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                        <Button
                ...
                <div className="space-y-6">
                  {Object.entries(groupedProps).map(([category, props], index) => (
                    ...
                    >
                      <Card style={{ fontSize: 'var(--fluid-base)', borderRadius: 'var(--fluid-radius)' }}>
                        <CardHeader className="pb-3">
                          <CardTitle className="flex items-center gap-2 capitalize" style={{ fontSize: 'var(--fluid-lg)' }}>
