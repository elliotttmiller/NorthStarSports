...
export const OtherPage = () => {
  ...
  const betTypes = [
    ...
    { id: 'live-betting', name: 'Live Betting', icon: Pulse, description: 'Real-time in-game betting' },
  ...
  <SmoothScrollContainer className="universal-responsive-container flex-1 scrollbar-hide" showScrollbar={false}>
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
