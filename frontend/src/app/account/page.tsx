// Migrated from src/pages/AccountPage.tsx
...
export default function AccountPage() {
  return (
    <AnimatePresence mode="wait">
      ...
      >
        <SmoothScrollContainer className="flex-1 min-h-0 h-full universal-responsive-container px-0 sm:px-4" maxHeight="100vh" showScrollbar={false}>
          <div className="pt-2 pb-24 sm:pb-4">
            <div className="max-w-2xl mx-auto px-4 py-8 md:px-0 md:py-12 flex flex-col gap-6 text-base">
              {/* Welcome Title */}
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="w-full mb-8 md:mb-10">
              ...
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.1 }} className="w-full">
