...
import { getTeam, getLeagueFromLeagueId, getLogoUrl, type TeamLogoConfig } from '@/lib/teamLogos'
...
export const TeamLogo = memo(function TeamLogo({
  ...
  const teamConfig = typeof team === 'string' 
    ? getTeam(team, league === 'nfl' || league === 'nba' ? league : getLeagueFromLeagueId(league || '') || undefined)
    : team
      ...
      <div className="flex flex-col">
        {showName && (
          <span className="font-semibold text-foreground leading-tight">
            {size === 'xs' || size === 'sm' ? teamConfig.name : `${teamConfig.city} ${teamConfig.name}`}
          </span>
        )}
...
export const TeamLogoWithName = memo((props: Omit<TeamLogoProps, 'showName'>) => (
