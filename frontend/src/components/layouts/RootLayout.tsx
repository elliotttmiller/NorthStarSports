        ...
        {isMobile ? (
          ...
          <div className="h-full flex relative">
            <div className="absolute left-0 top-1/2 -translate-y-1/2 z-30">
              <SidebarToggle side="left" isOpen={navigation.sideNavOpen} onToggle={toggleSideNav} />
            </div>
            <div className="absolute right-0 top-1/2 -translate-y-1/2 z-30">
              <SidebarToggle side="right" isOpen={navigation.actionHubOpen} onToggle={toggleActionHub} />
            </div>
            <AnimatePresence mode="wait">
