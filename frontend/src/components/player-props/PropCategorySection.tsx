      ...
      <CardContent className="p-0">
        ...
        >
          <div className="flex items-center gap-2">
            <span className={cn('font-semibold text-foreground', compact ? 'text-xs' : 'text-sm')}>{category.name}</span>
            <span className="ml-2 text-xs text-muted-foreground font-normal">({category.props.length})</span>
          </div>
