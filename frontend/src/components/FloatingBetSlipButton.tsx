  ...
  return (
    ...
    >
      <div
        ...
        style={{
          border: '2px solid',
          borderColor: navigation.isBetSlipOpen ? 'var(--color-accent)' : 'var(--color-border)',
          background: navigation.isBetSlipOpen ? 'var(--color-accent)' : 'var(--color-background)',
        ...
        onMouseLeave={e => {
          e.currentTarget.style.background = navigation.isBetSlipOpen ? 'var(--color-accent)' : 'var(--color-background)';
          e.currentTarget.style.border = navigation.isBetSlipOpen ? '2px solid var(--color-accent)' : '2px solid var(--color-border)';
        }}
      >
