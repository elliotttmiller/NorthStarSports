...
import { provideBetFeedback, mobileButtonAnimations, getStaggerDelay } from '@/lib/betInteractions';
...
export const CompactMobileGameRow = memo(({ game, index }: CompactMobileGameRowProps) => {
      ...
      <div className="grid grid-cols-4 gap-2">
        ...
        <div className="flex flex-col justify-between h-[60px]">
          ...
          <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
            ...
            >
              <span className="text-[10px] font-semibold">{formatOdds(game.odds.moneyline.away.odds)}</span>
            </Button>
          </motion.div>
          {/* Home ML */}
          <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
            ...
            >
              <span className="text-[10px] font-semibold">{formatOdds(game.odds.moneyline.home.odds)}</span>
            </Button>
          </motion.div>
        </div>
      </div>
            ...
            <div className="p-4 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <span className="font-medium">{gameDate.toLocaleDateString()}</span>
                </div>
              </div>
