...
export const SideNavPanel = () => {
  const { navigation, selectSport, selectLeague, setMobilePanel } = useNavigationStore();
    ...
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <div className="flex-1 min-h-0 overflow-hidden">
          <div
            className="h-full seamless-scroll overflow-y-auto px-2 md:px-4 py-2 md:py-4 nav-panel-font-size"
          >
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
